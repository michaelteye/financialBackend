...
@Console()
export class MigrateTestDailyInterestPaymentCommand {
  ...
  @Command({
    command: 'migrate:daily-interest-payment',
  })
  ...
  async _execute(opts?: any) {
   ...
   // const transactions =  await this.InterestPaymentService.payBezoFlexUsers()
    ...
    const transAccountSavingBeforeFeb2023= await this.InterestPaymentService.dailyInterestCalBezoFlexUsers()
