...
export class MandateController {
  ...
  // @RoleAuth(AuthUserRole.User)
  // @Get('/mandate/deactivate/:savingGoalId')
  // @ApiResponse({
  //   status: 201,
  //   description: 'Mandate successfully Cancelled.',
  // })
  // async AutoDeductCancelMandate(@Param("savingGoalId") mandateId: string): Promise<any> {
  //   return await this.service.deactivateBySavingsGoalId(mandateId);
  // }
